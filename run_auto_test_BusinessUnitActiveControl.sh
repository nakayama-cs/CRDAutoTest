...
endpoint="BusinessUnitActiveControl"
json_object_name="business_unit_active_control"
json_object_id_name="business_unit_active_control_id"
result_json_id_name="businessUnitActiveControlId"
host_info="http://localhost:8000"

echo '{}' > auto_test_empty.json
echo "{\"${json_object_name}\": {\"company_id\": \"1\"}}" > auto_test_create.json
