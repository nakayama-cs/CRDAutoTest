...
endpoint="BusinessUnitChangeNotification"
json_object_name="business_unit_change_notification"
json_object_id_name="business_unit_change_notification_id"
result_json_id_name="businessUnitChangeNotificationId"
host_info="http://localhost:8000"

echo '{}' > auto_test_empty.json
echo "{\"${json_object_name}\": {\"type_name\": \"test\", \"record_id\": \"1\"}}" > auto_test_create.json
