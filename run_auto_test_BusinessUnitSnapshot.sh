...
endpoint="BusinessUnitSnapshot"
json_object_name="business_unit_snapshot"
json_object_id_name="business_unit_snapshot_id"
result_json_id_name="businessUnitSnapshotId"
