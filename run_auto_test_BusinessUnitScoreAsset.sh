...
endpoint="BusinessUnitScoreAsset"
json_object_name="business_unit_score_asset"
json_object_id_name="business_unit_score_asset_id"
result_json_id_name="businessUnitScoreAssetId"
host_info="http://localhost:8000"

echo '{}' > auto_test_empty.json
echo "{\"${json_object_name}\": {\"code\": \"1\", \"category\": {}}}" > auto_test_create.json
